...
- [ ] What problem does the context API help solve?
          Rather than passing props down from parent to child (prop drilling). It allows us to get all the necessary data from context object instead.
- [ ] In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?
        Actions - This piece allows us to say what we want something to do. 
        Reducers - This is the logic of what we want to return to us back after saying the action.
        Store - This is the compartment that hold everything. It allows us to get data from one place. Hence the name, "Single Source Of True(data)"
- [ ] What is the difference between Application state and Component state? When would be a good time to use one over the other?
        Application state is global meanwhile component state is local ( can only pass down props to its children )
- [ ] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?
        redux-thunk allows us to return a function instead of an action object. 
- [ ] What is your favorite state management system you've learned and this sprint? Please explain why!
        I like redux just because of its scalability.
